		...
		class tourmaster_pb_element_tour_search{
			...
			static function get_content( $settings = array() ){
				...
				if( empty($fields) || in_array('keywords', $fields) ){
					$ret .= '<div class="tourmaster-tour-search-field tourmaster-tour-search-field-keywords" ' . gdlr_core_esc_style(array(
				...
				if( empty($fields) || in_array('tour_category', $fields) ){
					if( $settings['item-style'] == 'style-2' ){
						...
						$ret .= self::get_type_filter($settings, esc_html__('Category', 'tourmaster'), $tour_category, 'tour_category');
					}else{
						$tour_category = array(
							'' => ($placeholder)? esc_html__('Category', 'tourmaster'): esc_html__('Any', 'tourmaster')
						) + tourmaster_get_term_list('tour_category');
						$ret .= '<div class="tourmaster-tour-search-field tourmaster-tour-search-field-tour-category" ' . gdlr_core_esc_style(array(
							'padding-right' => empty($settings['space-between-input'])? '': $settings['space-between-input'],
							'margin-bottom' => empty($settings['space-between-input'])? '': $settings['space-between-input']
						)) . ' >';
				...
				foreach( $tax_fields as $tax_field => $tax_title ){
					if( empty($fields) || in_array($tax_field, $fields) ){
						if( $settings['item-style'] == 'style-2' ){
							...
							$ret .= '<div class="tourmaster-tour-search-field tourmaster-tour-search-field-tax" ' . gdlr_core_esc_style(array(
								'padding-right' => empty($settings['space-between-input'])? '': $settings['space-between-input'],
								'margin-bottom' => empty($settings['space-between-input'])? '': $settings['space-between-input']
							)) . ' >';
				...
				if( empty($fields) || in_array('duration', $fields) ){
					...
					$ret .= '<div class="tourmaster-tour-search-field tourmaster-tour-search-field-duration" ' . gdlr_core_esc_style(array(
						'padding-right' => empty($settings['space-between-input'])? '': $settings['space-between-input'],
						'margin-bottom' => empty($settings['space-between-input'])? '': $settings['space-between-input']
					)) . ' >';
				...
				if( empty($fields) || in_array('date', $fields) ){
					$ret .= '<div class="tourmaster-tour-search-field tourmaster-tour-search-field-date" ' . gdlr_core_esc_style(array(
						'padding-right' => empty($settings['space-between-input'])? '': $settings['space-between-input'],
						'margin-bottom' => empty($settings['space-between-input'])? '': $settings['space-between-input']
					)) . ' >';
				...
				if( empty($fields) || in_array('month', $fields) ){
					...
					$ret .= '<div class="tourmaster-tour-search-field tourmaster-tour-search-field-month" ' . gdlr_core_esc_style(array(
						'padding-right' => empty($settings['space-between-input'])? '': $settings['space-between-input'],
						'margin-bottom' => empty($settings['space-between-input'])? '': $settings['space-between-input']
					)) . ' >';
				...
				if( empty($fields) || in_array('min-price', $fields) ){
					...
					$ret .= '<div class="tourmaster-tour-search-field tourmaster-tour-search-field-min-price" ' . gdlr_core_esc_style(array(
						'padding-right' => empty($settings['space-between-input'])? '': $settings['space-between-input'],
						'margin-bottom' => empty($settings['space-between-input'])? '': $settings['space-between-input']
					)) . ' >';
				...
				if( empty($fields) || in_array('max-price', $fields) ){
					...
					$ret .= '<div class="tourmaster-tour-search-field tourmaster-tour-search-field-max-price" ' . gdlr_core_esc_style(array(
						'padding-right' => empty($settings['space-between-input'])? '': $settings['space-between-input'],
						'margin-bottom' => empty($settings['space-between-input'])? '': $settings['space-between-input']
					)) . ' >';
				...
				if( $settings['style'] == 'full' ){
					...
					if( !empty($settings['enable-rating-field']) && $settings['enable-rating-field'] == 'enable' ){
						...
						$ret .= '<div class="tourmaster-tour-search-field tourmaster-tour-search-field-rating clearfix" ' . gdlr_core_esc_style(array(
							'padding-right' => empty($settings['space-between-input'])? '': $settings['space-between-input'],
							'margin-bottom' => empty($settings['space-between-input'])? '': $settings['space-between-input']
						)) . ' >';
					...
					if( !empty($settings['filters']) ){
						...
						foreach( $settings['filters'] as $filter ){
							...
							$ret .= self::get_type_filter($settings, $taxonomy->label, $term_list, $filter);
						}
